  ...
  methods: {
    ...
    play: function (t) {
      if (this.root.data.pauseVideo) {
        ...
        if (!i) {
          var s = wx.createVideoContext(e, this);
    ...
    imgLoad: function (i) {
      var e, r = i.target.dataset.i,
        s = this.getNode(r);
      s.w ? (this.data.opts[1] && !this.data.ctrl[r] || -1 === this.data.ctrl[r]) && (e = 1) : e = i.detail.width, e && this.setData(t({}, "ctrl." + r, e))
    },
    linkTap: function (t) {
      ...
      }, e)), r && ("#" === r[0] ? this.root.navigateTo(r.substring(1)).catch(function () {}) : r.split("?")[0].includes("://") ? this.root.data.copyLink && wx.setClipboardData({
        data: r,
        success: function () {
          return wx.showToast({
            title: "链接已复制"
